  ...
  methods: {
      ...
      addTocart(){
        if(this.selectedOption =="no"){
          ...
          let addCart = new productClass(this.CoffeeOptions.pId,this.CoffeeOptions.coffeeName,this.CoffeeOptions.price,type,this.bType,this.bTemp,this.bSize,this.amount)
          this.total = 0
          this.amount=1;
          this.selectedOption = "no"
          this.flag = false
