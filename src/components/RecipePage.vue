...
.doppio {
  top: 5%;
  background: linear-gradient(to bottom, white 40%,#5B4644 40%, #87624F 70%);
}

.americano {
  top: 18.5%;
  background: linear-gradient(to bottom, white 13%,#859FB5 13%,#859FB5 50%, #87624F 50%);
}

.macchiato {
  top: 35%;
   background: linear-gradient(to bottom,white 20%,#F4E8DA 20%,#F4E8DA 40%, #87624F 40%);
}

.flatwhite {
  top: 50%;
  background: linear-gradient(to bottom,white 10%,#F4E8DA 10%,#DAB7A3 60%, #87624F 65%,#5B4644 90%);
}
